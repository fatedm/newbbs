...
<div class="col-main">
    <div class="focus">
        ...
        <div class="hot-info">
            <dl>
                ...
                <dd>
                    <span></span>发生大幅第三方斯蒂芬双方商定发，的方式的防守对方对方的方式的防守对方对方...<a href="" target="_blank">[详细]</a> </span>
                </dd>
            </dl>
    ...
    <div class="hots">
        <dl class="hots-title">
            <dt class="word"></dt>
            <dd>
                <a href="#" target="_blank">苹果退烧</a>
                <a href="#" target="_blank" class="highlight">苹果退烧</a>
                <a href="#" target="_blank">苹果退烧</a>
            </dd>
        </dl>
        <ul id="hot">
            <li class="hot-list first">
...
<div class="col-sub">
    <div class="hot-post focus">
        <h4 class="post-title">热点议题：<a href="#" target="_blank">违规后怎么办</a><s class="icon"></s></h4>
        <div class="hot-img" href="#">
            <a href="#" target="_blank" title="">
                <img src="http://img.f2e.taobao.net/img.png_120x120.jpg" alt="">
            </a>
            <div class="hot-detail">
                一直以来，淘宝网努力为卖家亲们营造健康有序良性经营环境...<a href="#">[详情]</a>
            </div>
        </div>
        <div class="info">
    ...
    <div class="right-box policy">
        <h2 class="icon-title"><a href="#">政策解读</a></h2>
        <div class="hot-news">
    ...
    <div class="right-box ju">
        <h2 class="icon-title"><a href="#">聚划算专区</a></h2>
        <div class="hot-news">
            <a href="#" target="_blank">
    ...
    <div class="right-box service">
        <h2 class="icon-title"><a href="#">服务之声专区</a></h2>
    ...
    <div class="right-box assess">
        <h2 class="icon-title"><a href="#">评价专区</a></h2>
        <div class="news-img-info">
            <a class="news-img" href="#" target="_blank">
                <img src="http://img.f2e.taobao.net/img.png_100x100.jpg">
            </a>
...
<div class="ss-box honest">
    <h2 class="icon-title"><a href="#">诚信防骗</a></h2>
    <div class="news-img-info">
        <a class="news-img" href="#" target="_blank">
            <img src="http://img.f2e.taobao.net/img.png_100x100.jpg">
        </a>
...
<div class="ss-box share">
    <h2 class="icon-title"><a href="#">干货分享</a></h2>
    <div class="news-img-info">
        <a class="news-img" href="#" target="_blank">
            <img src="http://img.f2e.taobao.net/img.png_100x100.jpg">
        </a>
...
<div class="ss-box deep">
    <h2 class="icon-title"><a href="#">深度解读</a></h2>
    <div class="news-img-info">
        <a class="news-img" href="#" target="_blank">
            <img src="http://img.f2e.taobao.net/img.png_100x100.jpg">
        </a>
